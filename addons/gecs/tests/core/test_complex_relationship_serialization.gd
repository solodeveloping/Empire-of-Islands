...
func test_complex_nested_relationships_serialization():
	...
	print(
		...
		" - Name: ",
		restored_player.name if restored_player else "null"
	)
	print(
		"Weapon found: ",
		restored_weapon != null,
		" - Name: ",
		restored_weapon.name if restored_weapon else "null"
	)
	print(
		"Attachment found: ",
		restored_attachment != null,
		" - Name: ",
		restored_attachment.name if restored_attachment else "null"
	)
	print(
		"Attachment2 found: ",
		restored_attachment2 != null,
		" - Name: ",
		restored_attachment2.name if restored_attachment2 else "null"
	)
