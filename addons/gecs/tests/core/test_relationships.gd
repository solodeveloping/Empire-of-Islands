...
func test_archetype_and_entity():
	...
	var entities_that_like_food = (
		ECS.world.query.with_relationship([Relationship.new(C_Likes.new(), GecsFood)]).execute()
	)
...
func test_weak_relationship_matching():
	...
	var heather_has_eats_apples = e_heather.has_relationship(
		Relationship.new(C_Eats.new(), e_apple)
	)
...
func test_weak_vs_strong_component_matching():
	...
	var strong_match_3_apples = e_bob.has_relationship(
		Relationship.new({C_Eats: {"value": {"_eq": 3}}}, e_apple)
	)
	var strong_match_5_apples = e_bob.has_relationship(
		Relationship.new({C_Eats: {"value": {"_eq": 5}}}, e_apple)
	)
	var strong_match_7_apples = e_alice.has_relationship(
		Relationship.new({C_Eats: {"value": {"_eq": 7}}}, e_apple)
	)
	...
	var weak_match_any_eats_alice = e_alice.has_relationship(
		Relationship.new(C_Eats.new(), e_apple)
	)
...
func test_multiple_relationships_same_component_type():
	...
	var entities_that_like_alice = Array(
		ECS.world.query.with_relationship([Relationship.new(C_Likes.new(), e_alice)]).execute()
	)
	var entities_that_like_heather = Array(
		ECS.world.query.with_relationship([Relationship.new(C_Likes.new(), e_heather)]).execute()
	)
...
func test_query_with_strong_relationship_matching():
	...
	var pizza_eaters_15 = Array(
		(
			ECS
			.world
			.query
			.with_relationship([Relationship.new({C_Eats: {"value": {"_eq": 15}}}, e_pizza)])
			.execute()
		)
	)
	...
	var apple_eaters_8 = Array(
		(
			ECS
			.world
			.query
			.with_relationship([Relationship.new({C_Eats: {"value": {"_eq": 8}}}, e_apple)])
			.execute()
		)
	)
	...
	var apple_eaters_5 = Array(
		(
			ECS
			.world
			.query
			.with_relationship([Relationship.new({C_Eats: {"value": {"_eq": 5}}}, e_apple)])
			.execute()
		)
	)
...
func test_relationship_removal_with_data_specificity():
	...
	var has_5_apples = e_bob.has_relationship(
		Relationship.new({C_Eats: {"value": {"_eq": 5}}}, e_apple)
	)
	var has_10_apples = e_bob.has_relationship(
		Relationship.new({C_Eats: {"value": {"_eq": 10}}}, e_apple)
	)
	...
	var still_has_5_apples = e_bob.has_relationship(
		Relationship.new({C_Eats: {"value": {"_eq": 5}}}, e_apple)
	)
	var still_has_10_apples = e_bob.has_relationship(
		Relationship.new({C_Eats: {"value": {"_eq": 10}}}, e_apple)
	)
...
func test_edge_case_null_component_data():
	...
	var matches_default = e_bob.has_relationship(
		Relationship.new({C_Likes: {"value": {"_eq": 0}}}, e_alice)
	)
	var matches_zero = e_bob.has_relationship(
		Relationship.new({C_Likes: {"value": {"_eq": 0}}}, e_alice)
	)
	...
	var matches_different = e_bob.has_relationship(
		Relationship.new({C_Likes: {"value": {"_eq": 1}}}, e_alice)
	)
...
func test_wildcard_and_null_targets_with_weak_matching():
	...
	var heather_eats_anything_weak = e_heather.has_relationship(
		Relationship.new(C_Eats.new(), null)
	)
	...
	var bob_eats_anything_strong = e_bob.has_relationship(
		Relationship.new({C_Eats: {"value": {"_eq": 5}}}, null)
	)
	var alice_eats_anything_strong = e_alice.has_relationship(
		Relationship.new({C_Eats: {"value": {"_eq": 3}}}, null)
	)
	var wrong_amount_strong = e_bob.has_relationship(
		Relationship.new({C_Eats: {"value": {"_eq": 999}}}, null)
	)
	...
	var bob_eats_wildcard_weak = e_bob.has_relationship(
		Relationship.new(C_Eats.new(), ECS.wildcard)
	)
	var alice_eats_wildcard_weak = e_alice.has_relationship(
		Relationship.new(C_Eats.new(), ECS.wildcard)
	)
...
func test_wildcard_relation_with_weak_matching():
	...
	var wildcard_rel_to_heather = e_alice.has_relationship(
		Relationship.new(ECS.wildcard, e_heather)
	)
...
func test_query_with_wildcards_and_strong_matching():
	...
	var entities_that_eat_8_anything = Array(
		(
			ECS
			.world
			.query
			.with_relationship([Relationship.new({C_Eats: {"value": {"_eq": 8}}}, null)])
			.execute()
		)
	)
	...
	var entities_that_eat_12_anything = Array(
		(
			ECS
			.world
			.query
			.with_relationship([Relationship.new({C_Eats: {"value": {"_eq": 12}}}, null)])
			.execute()
		)
	)
	...
	var entities_with_rel_to_bob = Array(
		ECS.world.query.with_relationship([Relationship.new(null, e_bob)]).execute()
	)
	...
	var entities_with_any_rel = Array(
		ECS.world.query.with_relationship([Relationship.new(null, null)]).execute()
	)
...
func test_mixed_wildcard_scenarios_with_strong_matching():
	...
	var eats_15_anything = Array(
		(
			ECS
			.world
			.query
			.with_relationship([Relationship.new({C_Eats: {"value": {"_eq": 15}}}, null)])
			.execute()
		)
	)
	var eats_25_anything = Array(
		(
			ECS
			.world
			.query
			.with_relationship([Relationship.new({C_Eats: {"value": {"_eq": 25}}}, null)])
			.execute()
		)
	)
	...
	var any_rel_to_pizza = Array(
		ECS.world.query.with_relationship([Relationship.new(null, e_pizza)]).execute()
	)
...
func test_component_based_relationships():
	...
	var heavy_damaged_entities = Array(
		(
			ECS
			.world
			.query
			.with_relationship([Relationship.new(c_damage_base, c_heavy_damage)])
			.execute()
		)
	)
	var light_damaged_entities = Array(
		(
			ECS
			.world
			.query
			.with_relationship([Relationship.new(c_damage_base, c_light_damage)])
			.execute()
		)
	)
	...
	var any_damaged_entities = Array(
		ECS.world.query.with_relationship([Relationship.new(c_damage_base, null)]).execute()
	)
...
func test_component_target_with_weak_matching():
	...
	var poison_1_entities = Array(
		(
			ECS
			.world
			.query
			.with_relationship(
				[Relationship.new(status_effect_marker, {C_Eats: {"value": {"_eq": 1}}})]
			)
			.execute()
		)
	)
	var poison_5_entities = Array(
		(
			ECS
			.world
			.query
			.with_relationship(
				[Relationship.new(status_effect_marker, {C_Eats: {"value": {"_eq": 5}}})]
			)
			.execute()
		)
	)
	...
	var bob_has_any_poison = e_bob.has_relationship(
		Relationship.new(status_effect_marker, C_Eats.new())
	)
	var alice_has_any_poison = e_alice.has_relationship(
		Relationship.new(status_effect_marker, C_Eats.new())
	)
	var heather_has_any_poison = e_heather.has_relationship(
		Relationship.new(status_effect_marker, C_Eats.new())
	)
	...
	var bob_poison_rel = e_bob.get_relationship(
		Relationship.new(status_effect_marker, C_Eats.new())
	)
	var alice_poison_rel = e_alice.get_relationship(
		Relationship.new(status_effect_marker, C_Eats.new())
	)
	var heather_poison_rel = e_heather.get_relationship(
		Relationship.new(status_effect_marker, C_Eats.new())
	)
...
func test_component_archetype_target_matching():
	...
	var entities_with_strength_buff = Array(
		ECS.world.query.with_relationship([Relationship.new(has_buff_marker, C_Likes)]).execute()
	)
	...
	var entities_with_speed_buff = Array(
		ECS.world.query.with_relationship([Relationship.new(has_buff_marker, C_Loves)]).execute()
	)
	...
	var heather_strength_rel = e_heather.get_relationship(
		Relationship.new(has_buff_marker, C_Likes.new())
	)
...
func test_multiple_component_targets_same_relationship():
	...
	var existing_alice_attacking = e_alice.get_relationships(
		Relationship.new(C_IsAttacking.new(), null)
	)
	...
	var fire_resistant_entities = Array(
		(
			ECS
			.world
			.query
			.with_relationship([Relationship.new(has_resistance_marker, fire_resistance)])
			.execute()
		)
	)
	var ice_resistant_entities = Array(
		(
			ECS
			.world
			.query
			.with_relationship([Relationship.new(has_resistance_marker, ice_resistance)])
			.execute()
		)
	)
	var poison_resistant_entities = Array(
		(
			ECS
			.world
			.query
			.with_relationship([Relationship.new(has_resistance_marker, poison_resistance)])
			.execute()
		)
	)
	...
	var heather_resistances = e_heather.get_relationships(
		Relationship.new(has_resistance_marker, null)
	)
	...
	var entities_with_fire_resistance_type = Array(
		(
			ECS
			.world
			.query
			.with_relationship([Relationship.new(has_resistance_marker, C_Eats)])
			.execute()
		)
	)
	var entities_with_ice_resistance_type = Array(
		(
			ECS
			.world
			.query
			.with_relationship([Relationship.new(has_resistance_marker, C_Loves)])
			.execute()
		)
	)
...
func test_broad_query_with_drill_down_filtering():
	...
	for entity in all_damaged_entities:
		var has_fire = entity.has_relationship(
			Relationship.new(C_Damaged.new(), C_FireDamage.new())
		)
		var has_poison = entity.has_relationship(
			Relationship.new(C_Damaged.new(), C_PoisonDamage.new())
		)
...
func test_component_query_based_removal():
	...
	(
		assert_bool(
			e_bob.has_relationship(Relationship.new({C_Eats: {"value": {"_eq": 5}}}, e_apple))
		)
		.is_true()
	)
	(
		assert_bool(
			e_bob.has_relationship(Relationship.new({C_Eats: {"value": {"_eq": 10}}}, e_apple))
		)
		.is_true()
	)
	(
		assert_bool(
			e_bob.has_relationship(Relationship.new({C_Eats: {"value": {"_eq": 15}}}, e_apple))
		)
		.is_true()
	)
	(
		assert_bool(
			e_bob.has_relationship(Relationship.new({C_Likes: {"value": {"_eq": 100}}}, e_apple))
		)
		.is_true()
	)
	...
	(
		assert_bool(
			e_bob.has_relationship(Relationship.new({C_Eats: {"value": {"_eq": 25}}}, e_apple))
		)
		.is_true()
	)  # 25 <= 30, still exists
	(
		assert_bool(
			e_bob.has_relationship(Relationship.new({C_Eats: {"value": {"_eq": 35}}}, e_apple))
		)
		.is_false()
	)  # 35 > 30, removed
	(
		assert_bool(
			e_bob.has_relationship(Relationship.new({C_Eats: {"value": {"_eq": 45}}}, e_apple))
		)
		.is_false()
	)  # 45 > 30, removed
	(
	...
	e_bob.remove_relationship(
		Relationship.new({C_Eats: {"value": {"_gte": 40, "_lte": 80}}}, e_apple)
	)
	...
	(
		assert_bool(
			e_bob.has_relationship(Relationship.new({C_Eats: {"value": {"_eq": 50}}}, e_apple))
		)
		.is_false()
	)  # 40 <= 50 <= 80, removed
	(
		assert_bool(
			e_bob.has_relationship(Relationship.new({C_Eats: {"value": {"_eq": 75}}}, e_apple))
		)
		.is_false()
	)  # 40 <= 75 <= 80, removed
	(
		assert_bool(
			e_bob.has_relationship(Relationship.new({C_Eats: {"value": {"_eq": 100}}}, e_apple))
		)
		.is_true()
	)  # 100 > 80, still exists
	...
	(
		assert_bool(
			e_bob.has_relationship(Relationship.new({C_Eats: {"value": {"_eq": 25}}}, e_pizza))
		)
		.is_false()
	)  # removed
	(
		assert_bool(
			e_bob.has_relationship(Relationship.new({C_Eats: {"value": {"_eq": 25}}}, e_alice))
		)
		.is_false()
	)  # removed
	(
...
func test_limited_relationship_removal():
	...
	(
		assert_bool(
			e_bob.has_relationship(Relationship.new({C_Eats: {"value": {"_eq": 20}}}, e_apple))
		)
		.is_true()
	)
	(
		assert_bool(
			e_bob.has_relationship(Relationship.new({C_Eats: {"value": {"_eq": 30}}}, e_apple))
		)
		.is_true()
	)
	(
		assert_bool(
			e_bob.has_relationship(Relationship.new({C_Eats: {"value": {"_eq": 40}}}, e_apple))
		)
		.is_true()
	)
	(
		assert_bool(
			e_bob.has_relationship(Relationship.new({C_Likes: {"value": {"_eq": 5}}}, e_apple))
		)
		.is_true()
	)
...
func test_component_target_relationship_by_component_query():
	...
	var entities_with_strength_buff = Array(
		(
			...
			.world
			.query
			.with_relationship([Relationship.new({C_TestA: {}}, C_TestC.new())])
			.execute()
		)
	)
