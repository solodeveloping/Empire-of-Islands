...
func test_component_query_matcher_array_membership():
	...
	(
		assert_bool(
			ComponentQueryMatcher.matches_query(component, {"value": {"_in": [40, 41, 42]}})
		)
		.is_true()
	)
	(
		assert_bool(ComponentQueryMatcher.matches_query(component, {"value": {"_in": [1, 2, 3]}}))
		.is_false()
	)

	# _nin tests
	(
		assert_bool(ComponentQueryMatcher.matches_query(component, {"value": {"_nin": [1, 2, 3]}}))
		.is_true()
	)
	(
		assert_bool(
			ComponentQueryMatcher.matches_query(component, {"value": {"_nin": [40, 41, 42]}})
		)
		.is_false()
	)
...
func test_component_query_matcher_custom_function():
	...
	(
		assert_bool(ComponentQueryMatcher.matches_query(component, {"value": {"func": is_even}}))
		.is_true()
	)
	...
	(
		assert_bool(ComponentQueryMatcher.matches_query(component, {"value": {"func": is_odd}}))
		.is_false()
	)
	...
	(
		assert_bool(ComponentQueryMatcher.matches_query(component, {"value": {"func": in_range}}))
		.is_true()
	)
...
func test_component_query_matcher_multiple_operators():
	...
	(
		assert_bool(
			ComponentQueryMatcher.matches_query(component, {"value": {"_gte": 40, "_lte": 60}})
		)
		.is_true()
	)
	...
	(
		assert_bool(
			ComponentQueryMatcher.matches_query(component, {"value": {"_gte": 40, "_lte": 45}})
		)
		.is_false()
	)
	...
	(
		assert_bool(
			ComponentQueryMatcher.matches_query(component, {"value": {"_ne": 0, "_gt": 30}})
		)
		.is_true()
	)
...
func test_component_query_matcher_falsy_values():
	...
	(
		assert_bool(ComponentQueryMatcher.matches_query(component_zero, {"value": {"_eq": 0}}))
		.is_true()
	)
	(
		assert_bool(ComponentQueryMatcher.matches_query(component_zero, {"value": {"_eq": 1}}))
		.is_false()
	)

	# Should handle 0 in ranges
	(
		assert_bool(ComponentQueryMatcher.matches_query(component_zero, {"value": {"_gte": 0}}))
		.is_true()
	)
	(
		assert_bool(ComponentQueryMatcher.matches_query(component_zero, {"value": {"_lte": 0}}))
		.is_true()
	)
	(
		assert_bool(ComponentQueryMatcher.matches_query(component_zero, {"value": {"_gt": 0}}))
		.is_false()
	)
	...
	(
		assert_bool(ComponentQueryMatcher.matches_query(component_negative, {"value": {"_eq": -5}}))
		.is_true()
	)
	(
		assert_bool(ComponentQueryMatcher.matches_query(component_negative, {"value": {"_lt": 0}}))
		.is_true()
	)
...
func test_component_query_matcher_nonexistent_property():
	...
	var component = C_TestA.new(42)
	(
		assert_bool(ComponentQueryMatcher.matches_query(component, {"nonexistent": {"_eq": 10}}))
		.is_false()
	)
