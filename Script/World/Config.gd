...
#}
#
#static func create_config_if_not_existing() -> ConfigFile:
...
#
#static func load_config_value(section: String, key: String, default) -> void:
	#set(key, config.get_value(section, key, default))
#
#static func load_config_values(sections: Dictionary) -> void:
